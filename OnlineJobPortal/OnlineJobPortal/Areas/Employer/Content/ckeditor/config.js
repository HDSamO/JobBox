...
CKEDITOR.editorConfig = function (config) {
    ...
    */
    ...
    config.filebrowserBrowseUrl = '/Areas/Employer/Content/ckfinder/ckfinder.html';
    config.filebrowserImageUrl = '/Areas/Employer/Content/ckfinder/ckfinder.html?Type=Images';
    config.filebrowserFlashUrl = '/Areas/Employer/Content/ckfinder/ckfinder.html?Type=Flash';
    config.filebrowserUploadUrl = '/Areas/Employer/Content/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload@type=Files';
    config.filebrowserImageUploadUrl = '/Areas/Employer/Content/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload@type=Images';
    config.filebrowserFlashUploadUrl = '/Areas/Employer/Content/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload@type=Flash';
    ...
    */
    ...
    CKFinder.setupCKEditor(null, "/Areas/Employer/Content/ckfinder");
};
